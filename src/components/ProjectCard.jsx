...
const ProjectCard = ({image, name, desc, tasks, linkGithub = null, linkWeb = null}) => {
    return (
        <>
            <div className="group bg-slate-50 border border-gray-200 rounded-lg shadow hover:bg-sky-200 dark:hover:bg-sky-900 duration-500 dark:bg-slate-600 dark:border-slate-900">
                <img 
