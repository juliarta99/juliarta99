    ...
    return (
        <>
            <div className="py-20 container mx-auto flex md:flex-row flex-col">
                <div className="p-5 md:p-0 w-72 md:w-1/3 xl:w-1/4 h-max mx-auto relative">
                ...
                <div className="space-y-4 text-justify mt-5 md:mt-0 ml-0 md:ml-10 md:w-2/3 xl:w-3/4">
